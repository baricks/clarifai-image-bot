require('axios');
require('tracery-grammar');

function getDescription() {
  console.log('getting description');
  run(document.getElementById('imgurl').value)
}
...
function parseResponse(resp) {
  ...
  //the tags are an array of nouns - add the nouns to a tracery grammar
  ...
  var poem = grammar.flatten('#sentence#')
  console.log(poem)
  return poem;
}
